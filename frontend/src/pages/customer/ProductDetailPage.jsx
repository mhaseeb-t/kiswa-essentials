...
import { ChevronLeft, Minus, Plus, MessageCircle, ChevronDown, ShoppingBag, Truck, RotateCcw, Shield, Star, Heart, Share2, Eye } from 'lucide-react';
...
const ProductDetailPage = () => {
  ...
  const images = [
    ...
    `https://picsum.photos/400/400?random=${product.id}c`,
  ];
  ...
  const reviews = [
    { name: 'Ahmed K.', rating: 5, comment: 'Exceptional quality and beautiful craftsmanship. Highly recommended!', date: '2 weeks ago' },
    { name: 'Sarah M.', rating: 5, comment: 'The fabric is premium and the stitching is flawless. Will order again.', date: '1 month ago' },
    { name: 'Rashid A.', rating: 4, comment: 'Great product, fast delivery. The color was exactly as shown.', date: '3 weeks ago' },
  ];
    ...
    <div className="min-h-screen bg-[#0c0c0e] pt-20 pb-16">
      <div className="max-w-[1400px] mx-auto px-6 lg:px-8">
              ...
              <div className="absolute top-4 right-4 flex flex-col gap-2">
                <button
                  ...
                  className={`p-3 rounded-full backdrop-blur-md transition-all ${
                    isWishlisted ? 'bg-[#c9b89a] text-[#0c0c0e]' : 'bg-[#0c0c0e]/60 text-[#f8f4ef]/70 hover:bg-[#0c0c0e]/80'
                  }`}
                >
              ...
              {images.map((img, index) => (
                <button
                  ...
                  className={`aspect-square rounded-xl overflow-hidden transition-all duration-300 ${
                    selectedImage === index
                      ? 'ring-2 ring-[#c9b89a] ring-offset-2 ring-offset-[#0c0c0e]'
                      : 'border border-[#2a2a2e] hover:border-[#c9b89a]/50'
                  }`}
                >
          ...
          <div className="animate-fadeInUp delay-200">
            ...
            <div className="flex items-center gap-3 mb-8">
              <div className="flex items-center gap-1">
                {[...Array(5)].map((_, i) => (
                  <Star key={i} className={`w-4 h-4 ${i < 4 ? 'text-[#c9b89a] fill-[#c9b89a]' : 'text-[#2a2a2e]'}`} />
                ))}
              </div>
              <span className="text-sm text-[#6b6b6b]">4.0 (24 reviews)</span>
            </div>

            {/* Description */}
            <p className="text-[#6b6b6b] leading-relaxed mb-8">
              Experience the perfect blend of tradition and elegance with our handcrafted
              collection. Made with premium materials and intricate detailing, this piece
              represents the finest in South Asian craftsmanship.
            </p>
              ...
              <div className="flex items-center gap-4">
                <div className="flex items-center bg-[#1a1a1e] border border-[#2a2a2e] rounded-full">
                  <button
                    ...
                    className="p-3 text-[#a8a4a0] hover:text-[#f8f4ef] hover:bg-[#2a2a2e] rounded-full transition-all"
                  >
                ...
                <span className="text-sm text-[#6b6b6b]">{product.stock} available</span>
              </div>
            </div>
            ...
            <div className="flex flex-col sm:flex-row gap-4 mb-8">
              <button
                ...
                className="flex-1 flex items-center justify-center gap-3 py-4 bg-[#c9b89a] text-[#0c0c0e] font-medium rounded-full hover:bg-[#d4c9a8] transition-all group"
              ...
              <button
                ...
                className="flex-1 py-4 border border-[#2a2a2e] text-[#f8f4ef] font-medium rounded-full hover:border-[#c9b89a]/50 hover:bg-[#1a1a1e]/50 transition-all"
                disabled={product.stock === 0}
              >
                Buy Now
              </button>
            ...
            <a
              ...
              className="flex items-center justify-center gap-3 py-4 bg-[#25D366]/10 border border-[#25D366]/30 rounded-full text-[#25D366] hover:bg-[#25D366]/20 transition-all mb-8"
            >
              ...
              {[
                ...
                <div key={section.key}>
                  <button
                    ...
                    className="w-full flex items-center justify-between py-5 text-[#f8f4ef] hover:text-[#c9b89a] transition-colors"
                  >
        ...
        <section className="mt-20">
          <h2 className="font-display text-3xl text-[#f8f4ef] mb-8">Customer Reviews</h2>
          <div className="grid md:grid-cols-3 gap-6">
            {reviews.map((review, index) => (
              <div key={index} className="bg-[#1a1a1e] border border-[#2a2a2e] rounded-2xl p-6 animate-fadeInUp" style={{ animationDelay: `${index * 100}ms` }}>
                <div className="flex items-center gap-1 mb-3">
                  {[...Array(5)].map((_, i) => (
                    <Star key={i} className={`w-4 h-4 ${i < review.rating ? 'text-[#c9b89a] fill-[#c9b89a]' : 'text-[#2a2a2e]'}`} />
                  ))}
                </div>
                <p className="text-[#a8a4a0] leading-relaxed mb-4">"{review.comment}"</p>
                <div className="flex items-center justify-between">
                  <span className="text-sm text-[#f8f4ef] font-medium">{review.name}</span>
